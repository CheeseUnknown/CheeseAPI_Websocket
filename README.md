...
### **`websocket.send(path: str, data: str | bytes | list | dict, sid: str | List[str] | Literal['*'] = '*')`**

发送消息，支持广播。

### **`await websocket.async_send(path: str, data: str | bytes | list | dict, sid: str | List[str] | Literal['*'] = '*')`**
